...
public final class Supplementaries {
    ...
    public static void initialiseDiscs()
    {
        ...
        discManager.addDisc(new Disc("supplementaries:music_disc.pancake", PANCAKE_SEGMENTS, 13.635));
        ...
        discManager.addDisc(new Disc("supplementaries:music_disc.heave_ho", DISC_HEAVE_HO_SEGMENTS, 0));
    }
